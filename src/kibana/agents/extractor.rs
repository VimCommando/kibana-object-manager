...
impl AgentsExtractor {
    ...
    pub fn new(client: Kibana, manifest: Option<super::AgentsManifest>) -> Self {
    ...
    pub async fn search_agents(&self, _query: Option<&str>) -> Result<Vec<Value>> {
        ...
        log::debug!("Fetching agents from {}", path);
    ...
    async fn fetch_agent(&self, agent_id: &str) -> Result<Value> {
        ...
        log::debug!("Fetching agent '{}' from {}", agent_id, path);
...
mod tests {
    ...
    fn test_extractor_creation() {
        ...
        let _extractor = AgentsExtractor::new(client, None);
    }
}
