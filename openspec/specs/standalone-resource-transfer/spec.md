# standalone-resource-transfer Specification

## Purpose
Defines manifest-free, resource-explicit import and export behavior for standalone Kibana Skills, Tools, Agents, and Workflows transfers.
