...
impl ToolsExtractor {
    ...
    pub fn new(client: Kibana, manifest: Option<super::ToolsManifest>) -> Self {
    ...
    pub async fn search_tools(&self, _query: Option<&str>) -> Result<Vec<Value>> {
        ...
        log::debug!("Fetching tools from {}", path);
    ...
    async fn fetch_tool(&self, tool_id: &str) -> Result<Value> {
        ...
        log::debug!("Fetching tool '{}' from {}", tool_id, path);
...
mod tests {
    ...
    fn test_extractor_creation() {
        ...
        let _extractor = ToolsExtractor::new(client, None);
    }
}
